...
class Inputs extends Component {
    ...
    register = (name, mobile, password, email, address, dob) => {
        if (name != '' && mobile != '') {
            axios.get('https://blueclans.com/breakdownbuddy/login.php?method=register&usertype=mechanic&mobile=' + mobile + '&password='+password+'&email='+email+'&address='+address+'&dob='+dob+'&name=' + name + '&message=User successfully created.login with ' + mobile + ' and otp is ')
                .then((response) => {
        ...
        return (
            <View style={styles.container}>
                <ScrollView>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('LoginMechanic')}>
