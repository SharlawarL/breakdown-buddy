import { StyleSheet, View, Text, Image, TextInput,ToastAndroid, TouchableOpacity, ScrollView } from 'react-native'
...
class Inputs extends Component {
  ...
  getMyBookings = (id) => {
      axios.get('https://blueclans.com/breakdownbuddy/login.php?method=getBooking&user_id='+id)
            .then((response) => {
